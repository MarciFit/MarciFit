...
Usa questa checklist dopo aver completato i passaggi in [supabase-setup.md](/Users/federicomarci/Desktop/MarciFit/docs/supabase/supabase-setup.md).

Per il pass manuale specifico `Safari -> web app Home` usa anche [safari-home-auth-pass.md](/Users/federicomarci/Desktop/MarciFit/docs/supabase/safari-home-auth-pass.md).
